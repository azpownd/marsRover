...
public class RoverDSLParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, RoverDSLGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getTasksAccess().getMissionlistAssignment(), "rule__Tasks__MissionlistAssignment");
			...
			builder.put(grammarAccess.getMissionAccess().getFinalsentenceAssignment_3_1(), "rule__Mission__FinalsentenceAssignment_3_1");
			...
			builder.put(grammarAccess.getMissionAccess().getSafetypropertyAssignment_7_1(), "rule__Mission__SafetypropertyAssignment_7_1");
			builder.put(grammarAccess.getMissionAccess().getObjectdistanceAssignment_8_1(), "rule__Mission__ObjectdistanceAssignment_8_1");
			builder.put(grammarAccess.getMissionAccess().getBordercolorAssignment_9_1(), "rule__Mission__BordercolorAssignment_9_1");
			builder.put(grammarAccess.getMissionAccess().getLakelistAssignment_10_1(), "rule__Mission__LakelistAssignment_10_1");
			builder.put(grammarAccess.getMissionAccess().getColorlistAssignment_11_1(), "rule__Mission__ColorlistAssignment_11_1");
			builder.put(grammarAccess.getMissionAccess().getMeasurelistAssignment_12_1(), "rule__Mission__MeasurelistAssignment_12_1");
			builder.put(grammarAccess.getMissionAccess().getFlashingcolorAssignment_13_1(), "rule__Mission__FlashingcolorAssignment_13_1");
			builder.put(grammarAccess.getMissionAccess().getTimeoutAssignment_14_1(), "rule__Mission__TimeoutAssignment_14_1");
